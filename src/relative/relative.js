...
angular.module('hall5714.tng.relative', [])
	// language related stuff, could easily move this to global landscape
	...
	.provider('$relative', ['time-language', function (language, $filter) {
		//private
		...
		function Relative() {
			...
			this.between = function(datetime, datetime2, suffix) {
				var date = dateObject(datetime),
						date2 = angular.isDefined(datetime2) ? dateObject(datetime2) : new Date();
